...
Route::get('/jobs/manage', 'ManageJobController@showManageJobs');
Route::get('/jobs/candidate/manage', 'CandidateManageJobController@showCandidateJobs');
...
Route::get('/recruiter-dashboard', 'RecruiterDashBoardController@showDashboard');
