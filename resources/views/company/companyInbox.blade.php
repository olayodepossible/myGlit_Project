        ...
        <div class="main-wrapper">
            ...
            <main>
                ...
                <ul class="panel-group" id="accordion">
                    <li>
                        <div class="panel panel-default content-wrappe">
                            <div class="panel-heading dropdown dropdown1 filter">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="#p1" data-toggle = "collapse" data-parent="#accordion" >
                            ...
                            <div id="p1"  class="panel-collapse collapse dropdown-contents dropdown-content1">
                    ...
                    <li>
                        <div class="panel panel-default content-wrappe">
                            <div class="panel-heading dropdown dropdown1 filter">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="#p2" data-toggle = "collapse" data-parent="#accordion" >
                                            <div  class="icons arrows ">
                                                <svg class="arrowD" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="20px" height="20px">
                                                    <path d="M0 0h24v24H0V0z" fill="none"/>
                                                    <path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"/>
                            ...
                            <div id="p2"  class="panel-collapse collapse dropdown-contents dropdown-content1">
                                <div class="table-list">
                                    <ul class="lists">
                                        <li>
                                            <div>
                    ...
                    <li>
                        <div class="panel panel-default content-wrappe">
                            <div class="panel-heading dropdown dropdown1 filter">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="#p3" data-toggle = "collapse" data-parent="#accordion" >
                                            <div  class="icons arrows ">
                                                <svg class="arrowD" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="20px" height="20px">
                                                    <path d="M0 0h24v24H0V0z" fill="none"/>
                                                    <path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"/>
                            ...
                            <div id="p3"  class="panel-collapse collapse dropdown-contents dropdown-content1">
                                <div class="table-list">
                                    <ul class="lists">
                                        <li>
                                            <div>
                    ...
                    <li>
                        <div class="panel panel-default content-wrappe">
                            <div class="panel-heading dropdown dropdown1 filter">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="#p4" data-toggle = "collapse" data-parent="#accordion" >
                                            <div  class="icons arrows ">
                                                <svg class="arrowD" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="20px" height="20px">
                                                    <path d="M0 0h24v24H0V0z" fill="none"/>
                                                    <path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"/>
                            ...
                            <div id="p4"  class="panel-collapse collapse dropdown-contents dropdown-content1">
                                <div class="table-list">
                                    <ul class="lists">
                                        <li>
                                            <div>
